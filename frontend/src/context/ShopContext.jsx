...
const ShopContextProvider = (props) => {
    ...
    // Hàm định dạng giá tiền (thêm dấu chấm mỗi 3 số 0)
    ...
    const addToCart = async (itemId, size) => {
        ...
        let cartData = { ...cartItems }; // Clone cartItems
    ...
    // Lấy giỏ hàng của người dùng từ backend khi đã đăng nhập
