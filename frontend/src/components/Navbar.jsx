...
const Navbar = () => {
    ...
    const logout = () => {
        ...
        setCartItems({});  // Cập nhật lại giỏ hàng
    
        // Cập nhật trạng thái token trong ShopContext
        setToken(null); // Đặt lại token trong context (nếu có)
        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    {/*-----------Dropdown Menu---------*/}
                    {token &&
                        <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-0 z-50'>
            ...
            {/* Sidebar menu for small screens (Menu thanh bên cho màn hình nhỏ) */}
